# Purpose: create a instructor info sheet with required info (semester, CRN, instructor name, instructor code), which will be combined with student info sheet (the registrar data). 
...
Instructor_Selected_Info = Data_Frame2[['Semester','CRN','Instructor_First_Name','Instructor_Last_Name','Instructor_Code']]
